...
export default function MovieCard({ movie, variant = 'default' }: Props) {
  ...
  return (
    <article
      ...
      role="article"
      aria-label={`Filme ${movie.Title}, lançado em ${movie.Year}`}
      tabIndex={0}
    >
      <div className="relative w-full h-full">
        ...
        <div
          ...
          aria-label="Ações rápidas do filme"
        >
          <button
      ...
      >
        <div className="mb-2 flex flex-wrap gap-2" aria-label="Gêneros do filme">
        ...
        <div className="flex justify-between items-center text-sm text-purple-400">
          ...
          <span>{movie.Runtime || 'Duração desconhecida'}</span>
        </div>
      </div>
